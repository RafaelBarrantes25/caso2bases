...
BEGIN
    ...
    -- Handler para evitar que un error en el log detenga la transacción principal
...
BEGIN
    ...
    START TRANSACTION;
        ...
        VALUES (
            ...
            p_focus,
            p_country_id,
            1, -- targetAudienceID por defecto
            1, -- configID por defecto
            TRUE
        );
...
BEGIN
    ...
    -- B. PAÍSES LATINOAMERICANOS Y MONEDAS
    ...
    -- C. 100 PRODUCTOS (Alineado con tabla Products: sin productTypeID)
    SET i = 1;
    WHILE i <= 100 DO
        INSERT IGNORE INTO Products (productID, name, categoryID, measurementId, enabled)
        VALUES (i, CONCAT('Producto Latam #', i), (i % 2) + 1, 1, TRUE);
        SET i = i + 1;
    END WHILE;
    ...
    WHILE i <= 9 DO
        ...
        CALL sp_create_whitelabel_site(
            i, CONCAT('Marca Latina AI ', i), v_country_index, 
    ...
    CALL sp_register_step_log('FIN: Orquestacion Latam completada.', 1, 1, v_admin_id);
END$$
