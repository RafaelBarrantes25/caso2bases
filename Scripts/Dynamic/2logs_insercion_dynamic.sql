...
/* ====================================================================
   4. ORQUESTACIÓN (LIMPIO DE PRODUCTTYPES)
   ==================================================================== */
...
BEGIN
    ...
    (2, 'Peru', 'PER', 0.18, TRUE),
    (3, 'Mexico', 'MEX', 0.16, TRUE),
    ...
    SET i = 1;
    WHILE i <= 100 DO
        -- Ajustado a: productID, name, categoryID, measurementId
        INSERT IGNORE INTO Products (productID, name, categoryID, measurementId, description, enabled)
        VALUES (i, CONCAT('Producto Base #', i), (i % 2) + 1, 1, 'Descripción automática', TRUE);
        SET i = i + 1;
    END WHILE;
